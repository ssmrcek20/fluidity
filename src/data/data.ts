...
export const quotes: string[] = [
  ...
  "Talk about your happy and sad moments in life.",
  "Do it, I know you're scared, but it will be worth it.",
  "Talk, laugh, cry, live as if it's your last because it will be one day.",
  "Cherish every moment with the people you love because nothing lasts forever.",
  "When someone makes you angry or sad, tell them so.",
  "Stop thinking and do what you want.",
]
